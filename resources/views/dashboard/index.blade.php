        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Data Pengguna</div>
    ...
    <div class="row">
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Catatan Uang Masuk</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Keuangan Per Kategori</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        @foreach ($pie_label as $index => $data)
                            <span class="mr-2">
                                <i class="fas fa-circle" style="color: {{ $pie_color[$index] }}"></i> {{ $data }}
                            </span>
                        @endforeach
                    </div>
                </div>
                ...
                tooltips: {
                    ...
                    callbacks: {
                        label: function (tooltipItem, chart) {
                            ...
                            return (
                                datasetLabel + ": Rp " + number_format(tooltipItem.yLabel)
                            );
                        },
                    },
                },
